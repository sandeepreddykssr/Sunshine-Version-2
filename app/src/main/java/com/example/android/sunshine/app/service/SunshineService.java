...
public class SunshineService extends IntentService {
    ...
    private static final String ACTION_UPDATE_WEATHER = "com.example.android.sunshine.app.action.UPDATE_WEATHER";
        ...
        if (intent != null) {
            ...
            switch (action) {
                case ACTION_UPDATE_WEATHER:
                    handleActionUpdateWeather();
                    break;
            }
        }
    }

    private void handleActionUpdateWeather() {
    ...
    static public class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.d(LOG_TAG, AlarmReceiver.class.getSimpleName() + " triggered at " + new Date());
            startActionWeatherUpdate(context);
        }
    }
}
